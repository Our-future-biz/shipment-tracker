// Code generated by the Encore v1.58.5 client generator. DO NOT EDIT.
...
export namespace shipments {
    ...
    export class ServiceClient {
        ...
        public async attachmentClassify(shipmentId: string, attachmentId: string, params: controllers.AttachmentClassifyRequest): Promise<controllers.AttachmentClassifyResponse> {
            // Now make the actual call to the API
        ...
        public async attachmentReview(shipmentId: string, attachmentId: string, params: controllers.AttachmentReviewRequest): Promise<controllers.AttachmentReviewResponse> {
            // Now make the actual call to the API
         ...
         */
        public async shipmentReleaseHouseBol(shipmentId: string): Promise<controllers.ReleaseHouseBolResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/shipments/${encodeURIComponent(shipmentId)}/house-bol-release`)
            return await resp.json() as controllers.ReleaseHouseBolResponse
        }
...
export namespace controllers {
     ...
     */
    export interface AttachmentClassifyRequest {
        documentType: string
    }
     ...
     */
    export interface AttachmentReviewRequest {
        status: string
        note?: string
    }
    ...
    export interface CreateRateResponse {
        rate: interfaces.ExchangeRateItem
    }
    ...
    export interface ListRatesResponse {
        rates: interfaces.ExchangeRateItem[]
    }
    ...
    export interface ReleaseHouseBolResponse {
        shipment: interfaces.ShipmentItem
    }
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "shipment-tracker-ysci-Generated-TS-Client (Encore/v1.58.5)";
        }
