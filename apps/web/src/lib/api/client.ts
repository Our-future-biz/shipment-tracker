...
export function Environment(name: string): BaseURL {
    return `https://${name}-visdm.encr.app`
}
...
/**
 * Client is an API client for the visdm Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "visdm-Generated-TS-Client (Encore/v1.58.3)";
        }
