...
class CustomerInvoiceRepository extends BaseRepository<typeof customerInvoiceTable> {
  constructor() {
  ...
  async findByCustomer(customerId: string) {
    return this.db
      ...
      .where(and(eq(customerInvoiceTable.customerId, customerId), isNull(customerInvoiceTable.deletedAt)))
